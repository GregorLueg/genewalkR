...
genes spanning multiple ontology subtrees at random. The signal genes will have
some VERY clear signal. Noise genes also still due to the nature of the 
synthetic data; however, to a lesser extent.
...
Looking which genes have significant associations with their pathways, we can
appreciate, these are nearly all of the signal genes, confirming how the
algorithm works.
...
- The Pathway Commons interactions, see [Rodchenkov, et al.](https://academic.oup.com/nar/article/48/D1/D489/5606621).
...
interaction networks. This is a helper to get the information:
...
We can appreciate quite a few interactions between the genes. We can proceed
here. Should you observe a low number of interaction connections, likely, your
gene set is too small and the approach will not work well.
