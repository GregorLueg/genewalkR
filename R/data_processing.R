# helpers to generate the internal db ------------------------------------------
...
#'
#' @keywords internal
ingest_gene_data <- function(dir_data) {
  # checks
...
#'
#' @keywords internal
ingest_reactome_data <- function(dir_data) {
  # checks
  checkmate::assertDirectoryExists(dir_data)
...
#'
#' @keywords internal
ingest_go_data <- function(obo_list) {
  # checks
...
#'
#' @keywords internal
ingest_reactome_genes <- function(dir_data) {
  # checks
  checkmate::assertDirectoryExists(dir_data)
...
#'
#' @keywords internal
ingest_gene_ontology_genes <- function(dir_data) {
  checkmate::assertDirectoryExists(dir_data)
...
#'
#' @keywords internal
ingest_reactome_ontology <- function(dir_data) {
  checkmate::assertDirectoryExists(dir_data)
...
#'
#' @keywords internal
ingest_gene_ontology_relations <- function(obo_list) {
  # checks
  checkmate::assertList(obo_list)
  checkmate::checkNames(names(obo_list), must.include = c("names", "namespace"))
...
#'
#' @keywords internal
ingest_string_interactions <- function(dir_data, threshold = 0.85) {
  # checks
  checkmate::assertDirectoryExists(dir_data)
...
#'
#' @keywords internal
ingest_reactome_interactions <- function(dir_data) {
  # checks
  checkmate::assertDirectoryExists(dir_data)
...
#'
#' @keywords internal
ingest_signor_interactions <- function(dir_data) {
  # checks
  checkmate::assertDirectoryExists(dir_data)
...
#'
#' @keywords internal
ingest_intact_interaction <- function(dir_data) {
  # checks
  checkmate::assertDirectoryExists(dir_data)
...
#'
#' @keywords internal
ingest_pc_interactions <- function(dir_data) {
  # checks
  checkmate::assertDirectoryExists(dir_data)
